...
class TensorTuple(Value):
    ...
    def detach(self):
        """Create a new tensor that shares the cached data but detaches from the graph."""
        # The "new" tensor behaves as a new reference to existing cached data
        # rather that an independent one. It does not contain `op` or `inputs`
        # fields.
